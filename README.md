# Controlling a Tech Element

This is an attempt to control a Tech Element from within a REPL.  
Note that you can connect to a channel and communicate to others that way as well
